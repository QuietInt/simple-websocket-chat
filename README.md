...
[Simple WebSocket Chat](https://github.com/Hideaku/simple-websocket-chat)
...
3. After the compilation is complete, build the project
```bash
make
```
...
make
```
That's it, the executable files are compiled
